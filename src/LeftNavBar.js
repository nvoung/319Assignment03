    ...
    >
      ...
      <div className="mb-4">
        ...
        <div className="d-flex flex-wrap">
          ...
          {/*<Button variant="warning" className="mb-2 me-2 btn-sm" onClick={()=>{filterCategory("electronics")}}>
electronics
</Button>
<Button variant="warning" className="mb-2 me-2 btn-sm" onClick={()=>{filterCategory("jewelery")}}>
jewelery
</Button>
<Button variant="warning" className="mb-2 me-2 btn-sm" onClick={()=>{filterCategory("men's clothing")}}>
men's clothing
</Button>
<Button variant="warning" className="mb-2 me-2 btn-sm" onClick={()=>{filterCategory("women's clothing")}}>
women's clothing
</Button> */}
        </div>
      </div>
